# :floppy_disk: MXE (M cross environment) [![License][license-badge]][license-page] ![Docker](https://github.com/strawberrymusicplayer/strawberry-mxe/actions/workflows/docker.yaml/badge.svg?branch=master)
