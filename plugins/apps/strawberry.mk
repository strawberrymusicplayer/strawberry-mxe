...
PKG             := strawberry
$(PKG)_IGNORE   :=
$(PKG)_VERSION  := e255b06
$(PKG)_CHECKSUM := 64e9e3f702005296c4271f410369f169c720c99c6f4b9a5bd2e79c9e76403048
...
define $(PKG)_BUILD_SHARED
    cd '$(BUILD_DIR)' && $(TARGET)-cmake '$(SOURCE_DIR)' \
        ...
        -DFORCE_GIT_REVISION="1.0.6-0-g$($(PKG)_VERSION)" \
        -DENABLE_DBUS=OFF \
    ...
    $(INSTALL) '$(SOURCE_DIR)/dist/windows/Registry.nsh'                           '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin'
    ...
    $(INSTALL) '$(PREFIX)/$(TARGET)/lib/gio/modules/libgioopenssl.dll'             '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/gio-modules'
    ...
    $(INSTALL) '$(PREFIX)/$(TARGET)/qt6/plugins/tls/qschannelbackend.dll'          '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/tls'
    ...
    $(INSTALL) '$(PREFIX)/$(TARGET)/bin/gstreamer-1.0/libgstaes.dll'               '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/gstreamer-plugins'
    ...
    $(INSTALL) '$(PREFIX)/$(TARGET)/bin/gstreamer-1.0/libgstbs2b.dll'              '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/gstreamer-plugins'
    ...
    $(INSTALL) '$(PREFIX)/$(TARGET)/bin/gstreamer-1.0/libgstfdkaac.dll'            '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/gstreamer-plugins'
    ...
    $(INSTALL) '$(PREFIX)/$(TARGET)/bin/gstreamer-1.0/libgsthls.dll'               '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/gstreamer-plugins'
    ...
    $(INSTALL) '$(PREFIX)/$(TARGET)/bin/gstreamer-1.0/libgstid3tag.dll'            '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/gstreamer-plugins'
    ...
    $(INSTALL) '$(PREFIX)/$(TARGET)/bin/gstreamer-1.0/libgstmpg123.dll'            '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/gstreamer-plugins'
    $(INSTALL) '$(PREFIX)/$(TARGET)/bin/gstreamer-1.0/libgstmusepack.dll'          '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/gstreamer-plugins'
    ...
    $(INSTALL) '$(PREFIX)/$(TARGET)/bin/gstreamer-1.0/libgsttwolame.dll'           '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/gstreamer-plugins'
    ...
    $(INSTALL) '$(PREFIX)/$(TARGET)/bin/gstreamer-1.0/libgstwavenc.dll'            '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/gstreamer-plugins'
    ...
    $(INSTALL) '$(PREFIX)/$(TARGET)/bin/gstreamer-1.0/libgstxingmux.dll'           '$(PREFIX)/$(TARGET)/apps/$(PKG)/bin/gstreamer-plugins'
