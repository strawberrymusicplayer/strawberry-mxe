...
$(PKG)_IGNORE   :=
$(PKG)_VERSION  := 0.23
$(PKG)_CHECKSUM := bf31a9b6bdf3e364669c7bd9858f97e4a0c408a8d22940c5d4ab638b65460f85
...
define $(PKG)_BUILD_$(BUILD)
    ...
    cd '$(BUILD_DIR)' && $(SOURCE_DIR)/configure $(MXE_CONFIGURE_OPTS) CFLAGS='-Wno-incompatible-pointer-types'
