...
$(PKG)_DESCR    := Secret Rabbit Code (aka libsamplerate) is a Sample Rate Converter for audio
$(PKG)_IGNORE   :=
$(PKG)_VERSION  := 0.1.9
...
define $(PKG)_BUILD
    ...
    cd '$(BUILD_DIR)' && '$(SOURCE_DIR)/configure' $(MXE_CONFIGURE_OPTS) --disable-fftw --disable-sndfile
