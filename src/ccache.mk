...
$(PKG)_IGNORE   :=
$(PKG)_VERSION  := 4.7.2
$(PKG)_CHECKSUM := 17ca75a577d49c1e4f2ac86d53126859de52b789cfe85dd532758518db114eaf
...
define $(PKG)_BUILD_$(BUILD)
    ...
    cmake -S '$(SOURCE_DIR)' -B '$(BUILD_DIR)' -DCMAKE_INSTALL_PREFIX='$(MXE_CCACHE_DIR)' -DZSTD_FROM_INTERNET=OFF -DREDIS_STORAGE_BACKEND=OFF
