...
define $(PKG)_BUILD
    cd '$(1)' && autoreconf -fi
    cd '$(1)' && ./configure $(MXE_CONFIGURE_OPTS) ac_cv_func_malloc_0_nonnull=yes
    # The ac_cv_func_malloc_0_nonnull=yes is needed because the configure check tries to run a program.
