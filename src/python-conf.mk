...
PYTHON_SETUP_INSTALL = cd '$(SOURCE_DIR)' && $(BUILD)-python$(PY_XY_VER) setup.py install --prefix='$(PREFIX)/$(TARGET)' --install-lib='$(PREFIX)/$(TARGET)/lib/python$(PY_XY_VER)/site-packages'
