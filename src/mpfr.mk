...
$(PKG)_DESCR    := The GNU MPFR Library
$(PKG)_IGNORE   :=
$(PKG)_VERSION  := 4.1.1
...
define $(PKG)_BUILD
    cd '$(1)' && ./configure $(MXE_CONFIGURE_OPTS) --enable-thread-safe --with-gmp-include='$(PREFIX)/$(TARGET)/include/' --with-gmp-lib='$(PREFIX)/$(TARGET)/lib/'
    $(MAKE) -C '$(1)' -j '$(JOBS)'
