...
PKG             := strawberry
$(PKG)_IGNORE   :=
$(PKG)_VERSION  := 55b0d1f
$(PKG)_CHECKSUM := 1ca2293e46498c74fb173637530ab4cba9f8b297d6bac121c3ae9c310c8aac0f
$(PKG)_GH_CONF  := jonaski/strawberry/branches/master
$(PKG)_WEBSITE  := https://www.strawbs.org/
$(PKG)_OWNER    := https://github.com/jonaski
$(PKG)_DEPS     := cc boost protobuf qtbase qtwinextras chromaprint gst-plugins-good gst-plugins-bad gst-plugins-ugly taglib libcdio libdeezer
